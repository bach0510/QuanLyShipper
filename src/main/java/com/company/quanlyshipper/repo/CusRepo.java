 ...
 * @author Admin
 */
public interface CusRepo extends BaseRepository<Customer, Integer> {
    
    @Query("SELECT c FROM Customer c WHERE c.CusTel = ?1 ")
    Customer findCustomerByTel(String cusTel);
